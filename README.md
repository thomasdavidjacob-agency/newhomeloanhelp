# New Home Loan Help — Deployment Checklist
...
3. **Verify your sending domain in Resend**
   Log in to resend.com and verify `newhomeloanhelp.com` so `leads@newhomeloanhelp.com` is authorized to send.
...
`🏠 New Lead: [Name] — [Loan Type] — newhomeloanhelp.com`
